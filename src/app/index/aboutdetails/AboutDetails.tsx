    ...
    <section className="py-16 px-6 lg:px-20 bg-gray-50">
      <div className="flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="flex-1 max-w-[700px]">
          ...
          >
            At <span className="font-semibold text-gray-900">OLATINN</span>, we are passionate about delivering technology solutions that empower businesses and individuals. From scalable cloud infrastructure to creative designs and innovative systems, our mission is to transform ideas into impactful realities.  
          </motion.p>

          {/* Four Animated Div Containers */}
