...
const AuthenticationSection = () => {
  ...
  return (
    <>
      {/* SEO for this section/page */}
      <NextSeo
        title="Smarter Authentication with Olatinn"
        description="Olatinn provides scalable authentication solutions, blending lightweight client-side validation with enterprise-grade server-side security."
        openGraph={{
          title: "Smarter Authentication with Olatinn",
          description:
            "Scalable, reliable, and secure authentication for modern businesses.",
          images: [
            {
              url: "/images/web1.webp",
              width: 800,
              height: 600,
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                At{" "}
                <span className="font-bold text-[#000271] text-lg leading-relaxed font-serif tracking-wide">
                  Olatinn
                </span>
                , we provide complete authentication solutions that combine both{" "}
                <span className="font-medium">
                  static HTML with DOM manipulation
                </span>{" "}
                for lightweight client-side validation and{" "}
                <span className="font-medium">
                  server-side smart authentication
                </span>{" "}
