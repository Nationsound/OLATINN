...
const Signin = () => {
  ...
  const handleSignin = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      // 1️⃣ Sign in user
      const res = await fetch("http://olatinn-api.us-east-1.elasticbeanstalk.com/olatinn/api/auth/signin", {
        method: "POST",
      ...
      const profileRes = await fetch("http://olatinn-api.us-east-1.elasticbeanstalk.com/olatinn/api/profile/user", {
        method: "GET",
        headers: {
